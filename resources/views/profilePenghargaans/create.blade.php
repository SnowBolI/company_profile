...
@section('title', 'Create Profile Penghargaan')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-12 mb-3">
                        <h3 align="center">Tambah Penghargaan</h3>
                    </div>
                    <form action="{{ route('profile_penghargaan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
