                    ...
                    <form action="{{ route('berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @if($berita->gambar_utama)
                                <img class="img-fluid rounded mx-auto d-block my-3" src="{{ Storage::url($berita->gambar_utama) }}" alt="Gambar Produk">
                            @else
                        ...
                        <div class="mb-3">
                            ...
                            @if($berita->gambar_2)
                                <img class="img-fluid rounded mx-auto d-block my-3" src="{{ Storage::url($berita->gambar_2) }}" alt="Gambar Produk">
                            @else
                        ...
                        <div class="mb-3">
                            ...
                            @if($berita->gambar_3)
                                <img class="img-fluid rounded mx-auto d-block my-3" src="{{ Storage::url($berita->gambar_3) }}" alt="Gambar Produk">
                            @else
