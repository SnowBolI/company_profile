...
@section('title', 'Create Karir Banner')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('karir_banner.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('karir_banner.index') }}" class="btn btn-secondary">Kembali</a>
