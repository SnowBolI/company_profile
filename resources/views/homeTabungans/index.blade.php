                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="/admin/home_tabungan/create" class="mb-3 btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                                ...
                                <!-- Form Pencarian -->
                                <form method="GET" action="{{ url('/admin/home_tabungan') }}" class="mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered border-light table-hover">
                                        ...
                                        <tbody>
                                            @php
                                                $i = ($homeTabungans->currentPage() - 1) * $homeTabungans->perPage() + 1;
                                            @endphp
                                            @foreach ($homeTabungans as $tabungan)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('home_tabungan.show', $tabungan->id) }}" class="btn btn-info btn-sm me-2">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('home_tabungan.edit', $tabungan->id) }}" class="btn btn-warning btn-sm me-2">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{ route('home_tabungan.destroy', $tabungan->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                    ...
                                    <!-- Pagination Links -->
                                    {{ $homeTabungans->links('pagination::bootstrap-4') }}
                                </div>
