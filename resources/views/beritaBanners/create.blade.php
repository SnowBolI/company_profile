...
@section('title', 'Create Berita Banner')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('berita_banner.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('berita_banner.index') }}" class="btn btn-secondary">Kembali</a>
