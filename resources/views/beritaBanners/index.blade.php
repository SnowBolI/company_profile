                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="/admin/berita_banner/create" class="mb-3 btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                                ...
                                <!-- Form Pencarian -->
                                <form method="GET" action="{{ url('/admin/berita_banner') }}" class="mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered border-light table-hover">
                                        ...
                                        <tbody>
                                            @php
                                                $i = ($beritaBanners->currentPage() - 1) * $beritaBanners->perPage() + 1;
                                            @endphp
                                            @foreach ($beritaBanners as $banner)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('berita_banner.show', $banner->id) }}" class="btn btn-info btn-sm me-2">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('berita_banner.edit', $banner->id) }}" class="btn btn-warning btn-sm me-2">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{ route('berita_banner.destroy', $banner->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                    ...
                                    <!-- Pagination Links -->
                                    {{ $beritaBanners->links('pagination::bootstrap-4') }}
                                </div>
