...
@section('title', 'Create Produk Tabungan')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('produk_tabungan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('produk_tabungan.index') }}" class="btn btn-secondary">Kembali</a>
