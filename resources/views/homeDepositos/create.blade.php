...
@section('title', 'Create Home Deposito')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('home_deposito.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('home_deposito.index') }}" class="btn btn-secondary">Kembali</a>
