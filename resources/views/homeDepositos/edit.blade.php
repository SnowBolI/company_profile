                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('home_deposito.update', $homeDeposito->id) }}" method="POST" >
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="jangka" class="form-control {{ $errors->first('jangka') ? 'is-invalid' : '' }}" name="jangka" placeholder="Jangka" value="{{ old('jangka', $homeDeposito->jangka) }}" required>
                            <div class="invalid-feedback">{{ $errors->first('jangka') }}</div>
                        </div>
                        <div class="mb-3">
                            <label for="nilai_persentase" class="font-weight-bold">Persentase</label>
                            <input type="number" step="0.000001" min="0" max="100" id="nilai_persentase" class="form-control {{ $errors->first('nilai_persentase') ? 'is-invalid' : '' }}" name="nilai_persentase" placeholder="5.5" value="{{ old('nilai_persentase', $homeDeposito->nilai_persentase*100) }}" required>
