...
@section('title', 'Create Laporan Banner')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('laporan_banner.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('laporan_banner.index') }}" class="btn btn-secondary">Kembali</a>
