...
@section('title', 'Create Profile Struktur')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-12 mb-3">
                        <h3 align="center">Tambah Struktur</h3>
                    </div>
                    <form action="{{ route('profile_struktur.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('profile_struktur.index') }}" class="btn btn-secondary">Kembali</a>
