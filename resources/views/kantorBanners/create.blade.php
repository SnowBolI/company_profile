...
@section('title', 'Create Kantor Banner')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('kantor_banner.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('kantor_banner.index') }}" class="btn btn-secondary">Kembali</a>
