...
@section('title', 'Create Home Thumbnail')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-12 mb-3">
                        <h3 align="center">Tambah Thumbnail</h3>
                    </div>
                    <form action="{{ route('home_thumbnail.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('home_thumbnail.index') }}" class="btn btn-secondary">Kembali</a>
