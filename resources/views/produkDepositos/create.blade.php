...
@section('title', 'Create Produk Deposito')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-12 mb-3">
                        <h3 align="center">Tambah Deposito</h3>
                    </div>
                    <form action="{{ route('produk_deposito.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('produk_deposito.index') }}" class="btn btn-secondary">Kembali</a>
