                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="/admin/home_slider/create" class="mb-3 btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                                ...
                                <!-- Form Pencarian -->
                                <form method="GET" action="{{ url('/admin/home_slider') }}" class="mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered border-light table-hover">
                                        ...
                                        <tbody>
                                            @php
                                                $i = ($homeSliders->currentPage() - 1) * $homeSliders->perPage() + 1;
                                            @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('home_slider.show', $slider->id) }}" class="btn btn-info btn-sm me-2">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('home_slider.edit', $slider->id) }}" class="btn btn-warning btn-sm me-2">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{ route('home_slider.destroy', $slider->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
