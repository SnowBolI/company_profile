...
@section('title', 'Create Home Background')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-12 mb-3">
                        <h3 align="center">Tambah Background</h3>
                    </div>
                    <form action="{{ route('home_background.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('home_background.index') }}" class="btn btn-secondary">Kembali</a>
